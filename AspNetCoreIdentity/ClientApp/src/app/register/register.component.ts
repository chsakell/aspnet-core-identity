...
export class RegisterComponent {
    ...
    register() {
        ...
        if (!this.externalRegistration.associate) {
            this.http.post<ResultVM>(this.baseUrl + 'api/account/register', this.user).subscribe(result => {
                let registerResult = result;
            ...
            this.http.post<ResultVM>(this.baseUrl + 'api/socialaccount/associate', this.externalRegistration).subscribe(result => {
